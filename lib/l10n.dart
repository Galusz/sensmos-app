...
const Map<String, String> _enMap = {
  ...
  "Pytamy ostatni raz: apka zapamięta osobny klucz dostępu do tuneli, więc portfel może zostać zamknięty.": "Last time we ask: the app stores a separate tunnel access key, so the wallet can stay locked.",
  ...
  "Maszyna w sieci noda — otworzysz ją stąd z dowolnego miejsca, przez tunel.": "A machine on the node’s network — open it from anywhere, through the tunnel.",
  "Cel widgetu „Terminal\"": "Target of the “Terminal” widget",
  "Widget na pulpicie otworzy od razu to połączenie, bez pytania.": "The home-screen widget opens this connection straight away, without asking.",
  ...
  "Widget na pulpicie otworzy od razu ten node, bez pytania.": "The home-screen widget opens this node straight away, without asking.",
  "Wybierz node — plugin zostanie do niego podpięty.": "Pick a node — the plugin will be added to it.",
  "Dodaj połączenie": "Add connection",
  "Nazwa celu": "Target name",
  "Panel WWW w sieci noda — router, drukarka, Pi-hole. Otworzysz go stąd z dowolnego miejsca, przez tunel.": "A web panel on the node’s network — router, printer, Pi-hole. Open it from anywhere, through the tunnel.",
  "Dodaj maszyny z sieci noda (serwer, NAS, Raspberry) — otworzysz je stąd z dowolnego miejsca, przez tunel.": "Add machines from the node’s network (server, NAS, Raspberry) — open them from anywhere, through the tunnel.",
  ...
  "Nowy PIN musi mieć co najmniej 4 znaki.": "The new PIN must be at least 4 characters.",
  "Zły obecny PIN. Jeśli zmieniałeś go z innego telefonu, wpisz tamten; po przeflashowaniu noda PIN wraca do 123456.": "Wrong current PIN. If you changed it from another phone, enter that one; after re-flashing a node the PIN goes back to 123456.",
  "Za dużo prób — node blokuje zmianę na 30 sekund.": "Too many attempts — the node blocks changes for 30 seconds.",
  "Node odrzucił zmianę (HTTP %s).": "The node rejected the change (HTTP %s).",
  "Nie widzę noda pod %s — połącz telefon z tą samą siecią WiFi.": "No response from %s — connect the phone to the same WiFi network.",
  "PIN chroni lokalne API noda: ustawienia, skrypty, MQTT i tryb serwisowy. Zmiana działa tylko w sieci noda.": "The PIN protects the node’s local API: settings, scripts, MQTT and service mode. Changing it only works on the node’s network.",
  "Obecny PIN": "Current PIN",
  "Nowy PIN (min. 4 znaki)": "New PIN (at least 4 characters)",
  "Po zmianie inne telefony z tym nodem zachowają stary PIN — trzeba go tam poprawić w tym samym miejscu.": "After the change, other phones paired with this node keep the old PIN — fix it there in the same place.",
  "Node ma za stare oprogramowanie — zaktualizuj je.": "The node firmware is too old — please update it.",
  "Node ma za stare oprogramowanie (%s) — zaktualizuj je do 1.01 lub nowszego.": "The node firmware is too old (%s) — update it to 1.01 or newer.",
  "Ramka odrzucona — zerwane szyfrowanie tunelu.": "Frame rejected — the tunnel encryption broke.",
  "Zapisuję PIN…": "Saving the PIN…",
  "Ustaw nowy PIN": "Set a new PIN",
  "gdy PIN się rozjechał albo go nie pamiętasz": "when the PIN drifted apart or you do not remember it",
  "Nowy PIN": "New PIN",
  "Połączenie serwisowe jest już autoryzowane — starego PIN-u nie trzeba znać.": "The service connection is already authorised — you do not need to know the old PIN.",
  "PIN ustawiony. Inne telefony z tym nodem trzeba poprawić osobno.": "PIN set. Other phones paired with this node have to be fixed separately.",
  "Ustawiam PIN na nodzie...": "Setting the PIN on the node...",
  "Bez PIN-u sprzed zmiany nie odczytam kopii portfela z noda.": "Without the PIN from before the change I cannot read the wallet copy from the node.",
  "PIN sprzed zmiany": "PIN from before the change",
  "Kopia portfela na nodzie jest zaszyfrowana PIN-em, który obowiązywał w chwili jej zapisu. Podaj tamten PIN — nowy jest już ustawiony i zostaje.": "The wallet copy on the node is encrypted with the PIN that was in force when it was saved. Enter that PIN — the new one is already set and stays.",
  ...
  "Usunie %s plików u sprzedawców. Opłaty kończą się z tą dobą, ponowny zakup zaczyna od zera.": "This deletes %s files at the sellers. Charges stop with today; buying again starts from scratch.",
  ...
  "kopii u Ciebie: %s · dowody 7 dni: %s ✓ %s ✗": "copies held: %s · proofs 7d: %s ✓ %s ✗",
  "zarobek 7 dni: %s · łącznie: %s GALU": "earned 7d: %s · total: %s GALU",
  "Odłączyć %s?": "Detach %s?",
  "Token przystawki zostanie odebrany, agent natychmiast traci dostęp.": "The attachment's token is revoked; the agent loses access immediately.",
  "Odłącz": "Detach",
  "Odłączono": "Detached",
  "Miejsce na pliki u innych właścicieli nodów, szyfrowane w telefonie.": "Space for your files at other node owners, encrypted on the phone.",
  "Kup miejsce": "Buy storage",
  "plików: %s · %s GALU na dobę": "files: %s · %s GALU per day",
  "Zaległość: %s dni — wysyłki wstrzymane, doładuj GALU": "Arrears: %s days — uploads paused, top up GALU",
  "Ukryj kartę": "Hide the card",
  "Karta ukryta — włączysz ją w Ustawieniach": "Card hidden — turn it back on in Settings",
...
const Map<String, String> _deMap = {
  ...
  "Pytamy ostatni raz: apka zapamięta osobny klucz dostępu do tuneli, więc portfel może zostać zamknięty.": "Wir fragen zum letzten Mal: Die App merkt sich einen separaten Tunnel-Zugriffsschlüssel, das Wallet kann also gesperrt bleiben.",
  "Nie udało się wydać tokenu dostępu.": "Zugriffstoken konnte nicht ausgestellt werden.",
  ...
  "Maszyna w sieci noda — otworzysz ją stąd z dowolnego miejsca, przez tunel.": "Ein Rechner im Netzwerk des Nodes — von überall erreichbar, durch den Tunnel.",
  "Cel widgetu „Terminal\"": "Ziel des „Terminal“-Widgets",
  "Widget na pulpicie otworzy od razu to połączenie, bez pytania.": "Das Homescreen-Widget öffnet diese Verbindung sofort, ohne Nachfrage.",
  ...
  "Widget na pulpicie otworzy od razu ten node, bez pytania.": "Das Homescreen-Widget öffnet diesen Node sofort, ohne Nachfrage.",
  "Wybierz node — plugin zostanie do niego podpięty.": "Wähle einen Node — das Plugin wird ihm hinzugefügt.",
  "Dodaj połączenie": "Verbindung hinzufügen",
  "Nazwa celu": "Name des Ziels",
  "Panel WWW w sieci noda — router, drukarka, Pi-hole. Otworzysz go stąd z dowolnego miejsca, przez tunel.": "Ein Web-Panel im Netzwerk des Nodes — Router, Drucker, Pi-hole. Von überall erreichbar, durch den Tunnel.",
  "Dodaj maszyny z sieci noda (serwer, NAS, Raspberry) — otworzysz je stąd z dowolnego miejsca, przez tunel.": "Füge Rechner aus dem Netzwerk des Nodes hinzu (Server, NAS, Raspberry) — von überall erreichbar, durch den Tunnel.",
  "Powiadomienia aktywne": "Benachrichtigungen sind an",
  "Nieaktywne — dotknij, aby włączyć": "Aus — zum Einschalten tippen",
  "Nie udało się włączyć powiadomień.": "Benachrichtigungen konnten nicht aktiviert werden.",
  "Nowy PIN musi mieć co najmniej 4 znaki.": "Die neue PIN muss mindestens 4 Zeichen haben.",
  "Zły obecny PIN. Jeśli zmieniałeś go z innego telefonu, wpisz tamten; po przeflashowaniu noda PIN wraca do 123456.": "Falsche aktuelle PIN. Wenn du sie von einem anderen Telefon geändert hast, gib diese ein; nach einem Neu-Flash des Nodes ist die PIN wieder 123456.",
  "Za dużo prób — node blokuje zmianę na 30 sekund.": "Zu viele Versuche — der Node sperrt die Änderung für 30 Sekunden.",
  "Node odrzucił zmianę (HTTP %s).": "Der Node hat die Änderung abgelehnt (HTTP %s).",
  "Nie widzę noda pod %s — połącz telefon z tą samą siecią WiFi.": "Keine Antwort von %s — verbinde das Telefon mit demselben WLAN.",
  "PIN chroni lokalne API noda: ustawienia, skrypty, MQTT i tryb serwisowy. Zmiana działa tylko w sieci noda.": "Die PIN schützt die lokale API des Nodes: Einstellungen, Skripte, MQTT und Servicemodus. Ändern geht nur im Netzwerk des Nodes.",
  "Obecny PIN": "Aktuelle PIN",
  "Nowy PIN (min. 4 znaki)": "Neue PIN (mindestens 4 Zeichen)",
  "Po zmianie inne telefony z tym nodem zachowają stary PIN — trzeba go tam poprawić w tym samym miejscu.": "Nach der Änderung behalten andere Telefone mit diesem Node die alte PIN — dort an derselben Stelle korrigieren.",
  "Node ma za stare oprogramowanie — zaktualizuj je.": "Die Firmware des Nodes ist zu alt — bitte aktualisiere sie.",
  "Node ma za stare oprogramowanie (%s) — zaktualizuj je do 1.01 lub nowszego.": "Die Firmware des Nodes ist zu alt (%s) — aktualisiere sie auf 1.01 oder neuer.",
  "Ramka odrzucona — zerwane szyfrowanie tunelu.": "Frame abgelehnt — die Tunnel-Verschlüsselung ist gebrochen.",
  "Zapisuję PIN…": "PIN wird gespeichert…",
  "Ustaw nowy PIN": "Neue PIN setzen",
  "gdy PIN się rozjechał albo go nie pamiętasz": "wenn die PIN auseinandergelaufen ist oder du sie nicht mehr weißt",
  "Nowy PIN": "Neue PIN",
  "Połączenie serwisowe jest już autoryzowane — starego PIN-u nie trzeba znać.": "Die Serviceverbindung ist bereits autorisiert — die alte PIN musst du nicht kennen.",
  "PIN ustawiony. Inne telefony z tym nodem trzeba poprawić osobno.": "PIN gesetzt. Andere Telefone mit diesem Node musst du separat korrigieren.",
  "Ustawiam PIN na nodzie...": "PIN wird auf dem Node gesetzt...",
  "Bez PIN-u sprzed zmiany nie odczytam kopii portfela z noda.": "Ohne die PIN von vor der Änderung kann ich die Wallet-Kopie vom Node nicht lesen.",
  "PIN sprzed zmiany": "PIN von vor der Änderung",
  "Kopia portfela na nodzie jest zaszyfrowana PIN-em, który obowiązywał w chwili jej zapisu. Podaj tamten PIN — nowy jest już ustawiony i zostaje.": "Die Wallet-Kopie auf dem Node ist mit der PIN verschlüsselt, die beim Speichern galt. Gib diese PIN ein — die neue ist bereits gesetzt und bleibt.",
  ...
  "Usunie %s plików u sprzedawców. Opłaty kończą się z tą dobą, ponowny zakup zaczyna od zera.": "Löscht %s Dateien bei den Anbietern. Die Gebühren enden mit heute; ein Neukauf beginnt von vorn.",
  ...
  "kopii u Ciebie: %s · dowody 7 dni: %s ✓ %s ✗": "Kopien bei dir: %s · Beweise 7 Tage: %s ✓ %s ✗",
  "zarobek 7 dni: %s · łącznie: %s GALU": "Verdienst 7 Tage: %s · gesamt: %s GALU",
  "Odłączyć %s?": "%s trennen?",
  "Token przystawki zostanie odebrany, agent natychmiast traci dostęp.": "Das Token wird entzogen; der Agent verliert sofort den Zugriff.",
  "Odłącz": "Trennen",
  "Odłączono": "Getrennt",
  "Miejsce na pliki u innych właścicieli nodów, szyfrowane w telefonie.": "Platz für deine Dateien bei anderen Node-Besitzern, auf dem Telefon verschlüsselt.",
  "Kup miejsce": "Speicher kaufen",
  "plików: %s · %s GALU na dobę": "Dateien: %s · %s GALU pro Tag",
  "Zaległość: %s dni — wysyłki wstrzymane, doładuj GALU": "Rückstand: %s Tage — Uploads pausiert, GALU aufladen",
  "Ukryj kartę": "Karte ausblenden",
  "Karta ukryta — włączysz ją w Ustawieniach": "Karte ausgeblendet — in den Einstellungen wieder einschalten",
  ...
  "Brak wolnego miejsca — wróć później": "Kein freier Platz — später wiederkommen",
