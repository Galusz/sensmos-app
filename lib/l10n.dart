...
const Map<String, String> _enMap = {
  ...
  "Zapisz te 24 słowa na papierze. Bez portfela i bez nich pliki są nie do odzyskania. Serwer ich nie zna.": "Write these 24 words down on paper. Without the wallet and without them the files cannot be recovered. The server does not know them.",
  "Zapisałem te słowa": "I have written the words down",
};
...
const Map<String, String> _deMap = {
  ...
  "Kod odzyskiwania": "Wiederherstellungscode",
  "Zapisz te 24 słowa na papierze. Bez portfela i bez nich pliki są nie do odzyskania. Serwer ich nie zna.": "Schreib diese 24 Wörter auf Papier. Ohne Wallet und ohne sie sind die Dateien nicht wiederherstellbar. Der Server kennt sie nicht.",
  "Zapisałem te słowa": "Ich habe die Wörter aufgeschrieben",
};
