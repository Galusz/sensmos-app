...
const Map<String, String> _enMap = {
  ...
  "Za mało POL — zostaw rezerwę na gas": "Not enough POL — leave a reserve for gas",
  ...
  "Gas zapłacisz w POL. Wysyłka jest nieodwracalna — sprawdź adres.": "Gas is paid in POL. The transfer is irreversible — check the address.",
  "Zostawiam 0.1 POL na gas. Wysyłka jest nieodwracalna — sprawdź adres.": "0.1 POL is kept for gas. The transfer is irreversible — check the address.",
  ...
  "Za mało POL — odbiór nagród (claim) wymaga gazu. Wpłać POL na adres portfela (QR na górze).": "Not enough POL — claiming rewards needs gas. Send POL to your wallet address (QR at the top).",
  "Zeskanuj adres (QR)": "Scan address (QR)",
  "Skieruj aparat na kod QR z adresem portfela": "Point the camera at a QR code with a wallet address",
  "Hasło portfela": "Wallet password",
  "Zalecane": "Recommended",
  "Klucz zaszyfrowany hasłem. Zapomniane hasło zresetujesz przy nodzie (tryb serwisowy + PIN).": "Key encrypted with a password. Reset a forgotten password at your node (service mode + PIN).",
  "Zaszyfruj klucz hasłem — chroni środki, gdyby ktoś wykradł dane aplikacji. Zapomniane hasło zresetujesz przy nodzie.": "Encrypt the key with a password — it protects your funds if someone steals the app's data. Reset a forgotten password at your node.",
  ...
  "Zapamiętaj PIN swojego noda — to jedyna droga odzysku, jeśli zapomnisz hasła.": "Remember your node's PIN — it's the only way to recover if you forget the password.",
  "Hasła nie są takie same": "Passwords don't match",
  "Hasło włączone — portfel zaszyfrowany.": "Password enabled — wallet encrypted.",
  "Wyłączyć hasło?": "Disable password?",
  "Klucz wróci do ochrony samego telefonu. Podaj obecne hasło.": "The key will fall back to phone-only protection. Enter your current password.",
  "Hasło wyłączone.": "Password disabled.",
  "Odblokuj portfel": "Unlock wallet",
  "Portfel jest chroniony hasłem. Podaj je, aby wykonywać operacje.": "The wallet is password-protected. Enter it to perform operations.",
  "Zapomniałem": "Forgot",
  "Odzyskaj portfel z noda (Ustawienia noda → tryb serwisowy Bluetooth) — to zresetuje hasło.": "Recover your wallet from the node (Node settings → Bluetooth service mode) — this resets the password.",
  "Portfel zablokowany": "Wallet locked",
  "Podaj hasło, aby odblokować portfel.": "Enter your password to unlock the wallet.",
  "Zapomniałem hasła": "I forgot my password",
  "Portfel zablokowany — odblokuj hasłem, aby wykonać operację.": "Wallet locked — unlock with your password to perform the operation.",
  "Błędne hasło": "Wrong password",
  "Kopia zapasowa i odzysk": "Backup and recovery",
  "zapisz klucz offline albo odzyskaj portfel": "save the key offline or recover the wallet",
  "Zapisz kopię zapasową": "Save a backup",
  "klucz do zapisania offline — na wypadek utraty telefonu i noda": "a key to store offline — in case you lose your phone and node",
  "Odzyskaj portfel z kopii": "Recover wallet from backup",
  "wpisz zapisany klucz — tylko jeśli sam go stworzyłeś": "enter a saved key — only if you created it yourself",
  "Wpisz klucz z własnej kopii zapasowej, aby odzyskać portfel. Rób to tylko na swoim telefonie i tylko kluczem, który sam stworzyłeś.": "Enter the key from your own backup to recover the wallet. Do this only on your own phone and only with a key you created yourself.",
  "Przepisz na kartkę i schowaj. To Twoja kopia zapasowa na wypadek utraty telefonu — nie służy do wklejania w innych aplikacjach.": "Write it on paper and store it safely. It's your backup in case you lose your phone — not for pasting into other apps.",
  "⚠️ To jest klucz do Twoich środków. NIKT — ani my, ani żadna strona, giełda czy „pomoc na forum\" — nie ma prawa Cię o niego prosić. Nie wysyłaj go, nie wklejaj online, nie rób zdjęcia. Zapisz go na papierze i trzymaj offline.": "⚠️ This is the key to your funds. NO ONE — not us, not any website, exchange, or 'forum helper' — has the right to ask for it. Don't send it, don't paste it online, don't photograph it. Write it on paper and keep it offline.",
  ...
  "awaryjne, odbiór czujników, wysyłka, inbox": "emergency, sensor receive, send, inbox",
  "Ten node nie ma radia LoRa (albo firmware bez LoRa).": "This node has no LoRa radio (or firmware without LoRa).",
  "Encje nadawane beaconem przy padzie internetu + komendy z Panelu Emergency.": "Entities broadcast when internet is down + commands from the Emergency Panel.",
  "Odbiór ramek (czujniki LoRa)": "Frame receive (LoRa sensors)",
  "dzień użycia": "day of use",
  "Fraza-klucz zostaje TYLKO na nodzie — tę samą wpisz w swoje czujniki. Serwer przekazuje ramki na ślepo.": "The key phrase stays ONLY on the node — enter the same one in your sensors. The server relays frames blindly.",
  "klucz ustawiony — wpisz, by zmienić": "key set — type to change",
  "fraza-klucz": "key phrase",
  "klucz ustawiony": "key set",
  "brak klucza": "no key",
  "Przyjmuj ramki jawne (bez szyfrowania)": "Accept plain frames (no encryption)",
  "Uwaga: jawną ramkę może nadać każdy, kto zna adres noda.": "Note: anyone who knows the node address can send a plain frame.",
  ...
  "Zakolejkowane — nadanie w ciągu kilku(nastu) sekund": "Queued — transmitting within seconds",
  "Inbox LoRa": "LoRa inbox",
  "Pusto — ramki i komendy odebrane przez LoRa pojawią się tutaj.": "Empty — frames and commands received over LoRa will appear here.",
  "Wydatki usług": "Service expenses",
  "ryczałty dobowe — ostatnie 30 dni": "daily flat fees — last 30 days",
  "Brak naliczeń — płatne funkcje nie były używane.": "No charges — paid features were not used.",
...
const Map<String, String> _deMap = {
  ...
  "Za mało POL — zostaw rezerwę na gas": "Nicht genug POL — lass eine Reserve für Gas",
  ...
  "Gas zapłacisz w POL. Wysyłka jest nieodwracalna — sprawdź adres.": "Gas wird in POL bezahlt. Die Überweisung ist unumkehrbar — prüfe die Adresse.",
  "Zostawiam 0.1 POL na gas. Wysyłka jest nieodwracalna — sprawdź adres.": "0,1 POL werden für Gas zurückbehalten. Die Überweisung ist unumkehrbar — prüfe die Adresse.",
  "Potwierdź wysyłkę": "Überweisung bestätigen",
  "Wysyłasz %s %s": "Du sendest %s %s",
  "na adres:": "an Adresse:",
  "Tej operacji NIE można cofnąć.": "Dieser Vorgang kann NICHT rückgängig gemacht werden.",
  "Za mało POL — odbiór nagród (claim) wymaga gazu. Wpłać POL na adres portfela (QR na górze).": "Nicht genug POL — das Abholen der Belohnungen (Claim) benötigt Gas. Sende POL an deine Wallet-Adresse (QR oben).",
  "Zeskanuj adres (QR)": "Adresse scannen (QR)",
  "Skieruj aparat na kod QR z adresem portfela": "Richte die Kamera auf einen QR-Code mit einer Wallet-Adresse",
  "Hasło portfela": "Wallet-Passwort",
  "Zalecane": "Empfohlen",
  "Klucz zaszyfrowany hasłem. Zapomniane hasło zresetujesz przy nodzie (tryb serwisowy + PIN).": "Schlüssel mit Passwort verschlüsselt. Vergessenes Passwort setzt du am Node zurück (Servicemodus + PIN).",
  "Zaszyfruj klucz hasłem — chroni środki, gdyby ktoś wykradł dane aplikacji. Zapomniane hasło zresetujesz przy nodzie.": "Verschlüssle den Schlüssel mit einem Passwort — es schützt dein Guthaben, falls jemand die App-Daten stiehlt. Vergessenes Passwort setzt du am Node zurück.",
  ...
  "Zapamiętaj PIN swojego noda — to jedyna droga odzysku, jeśli zapomnisz hasła.": "Merke dir die PIN deines Nodes — sie ist der einzige Weg zur Wiederherstellung, wenn du das Passwort vergisst.",
  "Hasła nie są takie same": "Passwörter stimmen nicht überein",
  "Hasło włączone — portfel zaszyfrowany.": "Passwort aktiviert — Wallet verschlüsselt.",
  "Wyłączyć hasło?": "Passwort deaktivieren?",
  "Klucz wróci do ochrony samego telefonu. Podaj obecne hasło.": "Der Schlüssel wird nur noch durch das Telefon geschützt. Gib dein aktuelles Passwort ein.",
  "Hasło wyłączone.": "Passwort deaktiviert.",
  "Odblokuj portfel": "Wallet entsperren",
  "Portfel jest chroniony hasłem. Podaj je, aby wykonywać operacje.": "Das Wallet ist passwortgeschützt. Gib es ein, um Vorgänge auszuführen.",
  "Zapomniałem": "Vergessen",
  "Odzyskaj portfel z noda (Ustawienia noda → tryb serwisowy Bluetooth) — to zresetuje hasło.": "Stelle dein Wallet über den Node wieder her (Node-Einstellungen → Bluetooth-Servicemodus) — das setzt das Passwort zurück.",
  "Portfel zablokowany": "Wallet gesperrt",
  "Podaj hasło, aby odblokować portfel.": "Gib dein Passwort ein, um das Wallet zu entsperren.",
  "Zapomniałem hasła": "Passwort vergessen",
  "Portfel zablokowany — odblokuj hasłem, aby wykonać operację.": "Wallet gesperrt — mit Passwort entsperren, um den Vorgang auszuführen.",
  "Błędne hasło": "Falsches Passwort",
  "Kopia zapasowa i odzysk": "Backup und Wiederherstellung",
  "zapisz klucz offline albo odzyskaj portfel": "Schlüssel offline speichern oder Wallet wiederherstellen",
  "Zapisz kopię zapasową": "Backup speichern",
  "klucz do zapisania offline — na wypadek utraty telefonu i noda": "ein Schlüssel zum Offline-Speichern — falls du Telefon und Node verlierst",
  "Odzyskaj portfel z kopii": "Wallet aus Backup wiederherstellen",
  "wpisz zapisany klucz — tylko jeśli sam go stworzyłeś": "gespeicherten Schlüssel eingeben — nur wenn du ihn selbst erstellt hast",
  "Wpisz klucz z własnej kopii zapasowej, aby odzyskać portfel. Rób to tylko na swoim telefonie i tylko kluczem, który sam stworzyłeś.": "Gib den Schlüssel aus deinem eigenen Backup ein, um das Wallet wiederherzustellen. Tu das nur auf deinem eigenen Telefon und nur mit einem Schlüssel, den du selbst erstellt hast.",
  "Przepisz na kartkę i schowaj. To Twoja kopia zapasowa na wypadek utraty telefonu — nie służy do wklejania w innych aplikacjach.": "Schreibe ihn auf Papier und bewahre ihn sicher auf. Es ist dein Backup, falls du dein Telefon verlierst — nicht zum Einfügen in andere Apps.",
  "⚠️ To jest klucz do Twoich środków. NIKT — ani my, ani żadna strona, giełda czy „pomoc na forum\" — nie ma prawa Cię o niego prosić. Nie wysyłaj go, nie wklejaj online, nie rób zdjęcia. Zapisz go na papierze i trzymaj offline.": "⚠️ Das ist der Schlüssel zu deinem Guthaben. NIEMAND — weder wir noch eine Website, Börse oder ‚Forum-Hilfe' — darf danach fragen. Sende ihn nicht, füge ihn nicht online ein, fotografiere ihn nicht. Schreibe ihn auf Papier und bewahre ihn offline auf.",
  ...
  // ── 1.5.51: sekcja LoRa (odbiór/wysyłka/inbox) + Wydatki usług ──
  "awaryjne, odbiór czujników, wysyłka, inbox": "Notfall, Sensor-Empfang, Senden, Inbox",
  "Ten node nie ma radia LoRa (albo firmware bez LoRa).": "Dieser Node hat kein LoRa-Funkmodul (oder Firmware ohne LoRa).",
  "Encje nadawane beaconem przy padzie internetu + komendy z Panelu Emergency.": "Entitäten, die bei Internetausfall gesendet werden + Befehle aus dem Notfall-Panel.",
  "Odbiór ramek (czujniki LoRa)": "Frame-Empfang (LoRa-Sensoren)",
  "dzień użycia": "Nutzungstag",
  "Fraza-klucz zostaje TYLKO na nodzie — tę samą wpisz w swoje czujniki. Serwer przekazuje ramki na ślepo.": "Die Schlüsselphrase bleibt NUR auf dem Node — gib dieselbe in deine Sensoren ein. Der Server leitet Frames blind weiter.",
  "klucz ustawiony — wpisz, by zmienić": "Schlüssel gesetzt — tippen zum Ändern",
  ...
  "Uwaga: jawną ramkę może nadać każdy, kto zna adres noda.": "Hinweis: einen unverschlüsselten Frame kann jeder senden, der die Node-Adresse kennt.",
  ...
  "Zakolejkowane — nadanie w ciągu kilku(nastu) sekund": "In Warteschlange — Senden innerhalb von Sekunden",
  "Inbox LoRa": "LoRa-Inbox",
  "Pusto — ramki i komendy odebrane przez LoRa pojawią się tutaj.": "Leer — über LoRa empfangene Frames und Befehle erscheinen hier.",
  "Wydatki usług": "Dienst-Ausgaben",
  "ryczałty dobowe — ostatnie 30 dni": "Tagespauschalen — letzte 30 Tage",
  "Brak naliczeń — płatne funkcje nie były używane.": "Keine Abbuchungen — bezahlte Funktionen wurden nicht genutzt.",
